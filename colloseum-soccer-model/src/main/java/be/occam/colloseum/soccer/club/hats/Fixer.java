...
public class Fixer extends Hat {
	...
	public List<Plan> whatAreThePlannedMatchesAfter( Date date ) {
		...
		for ( Event event : events ) {
			...
			if ( match.isFirstToCome() ) {
				
				match.setRegistrationStatus( this.registrationStatus( match ) );
